const FishIcon = () => {
    return (
        <svg viewBox="0 0 512 512" width="1.2em" height="1.2em">
            ...
            <circle cx="416" cy="239.99" r="16" fill="currentColor"></circle>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit="20" strokeWidth="32" d="M378.37 356a199.22 199.22 0 0 1 0-200"></path>
        </svg>
    );
}
